...
<!--
time 00:08:00  introduction of this talk
...
1) Configuration of Attestation
1) Kata containers policy
1) Container repository policy
1) Much more
...
Kata containers, Pod access permissions and what can the pod access of hardware amongst other things.
What are allowed container repos
...
1) Rego policies
1) Premade configurable hardware attestation
1) Resource access
